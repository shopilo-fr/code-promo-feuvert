#!/usr/bin/env python3
"""
Recuperation des codes promo Feu Vert depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/feuvert.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/feuvert.fr"
STORE_NAME = "Feu Vert"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Feu Vert depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-feuvert)"
    }
    try:
