 ...
 * Homepage: https://shopilo.fr/reductions/feuvert.fr
 */

const SHOPILO_URL = "https://shopilo.fr/reductions/feuvert.fr";
const STORE_NAME  = "Feu Vert";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-fr/code-promo-feuvert)" }
  });
